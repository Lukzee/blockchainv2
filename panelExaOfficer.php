 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo root; ?>paneleo"></i> Exam Officer</a>
          </li>
...
<!--/.Navbar -->
	...
	<form id="addUser">
        <div class="row" style="margin-top: 100px; padding-left: 10px;">
        	<div class="col-md-3">
        		<input class="form-control" type="email" name="newUemail" id="email" placeholder="email" <?php if (!empty($grow['email'])) { echo 'value="'.$grow['email'].'"'; } ?>>
        	</div>
        	<div class="col-md-3">
			...
			<input type="hidden" name="role" value="exam-officer">
        	<div class="col-md-3">
