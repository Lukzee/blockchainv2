...
?>
 	...
 	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent-333">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link active" href="<?php echo root; ?>admin"></i> Examiner</a>
				</li>
	...
	<form id="addUser">
        <div class="row" style="margin-top: 100px; padding-left: 10px;">
        	...
        	<div class="col-md-3">
        		<input class="form-control" type="text" name="course" id="course" placeholder="course" required <?php if (!empty($grow['course'])) { echo 'value="'.$grow['course'].'"'; } ?>>
        	</div>
